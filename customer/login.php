...
if(isset($_POST['login'])) {
	...
	if($phone == "") {
		echo "Either phonefield is empty.";
		echo "<br/>";
		echo "<a href='login.php'>Go back</a>";
	} else {
        $result = mysqli_query($mysqli, "SELECT * FROM `customer` WHERE customer.phone ='$phone'")
            ...
            <div class="col-12">
                ...
                <main class="row">
                    <div class="col-lg-4 col-md-6 col-sm-8 mx-auto bg-white py-3 mb-4">
                        <div class="row">
                            <div class="col-12">
                                <form action="login.php" name="form1" method="post" action="">
                                    <div class="form-group">
