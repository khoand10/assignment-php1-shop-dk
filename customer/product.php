        ...
        <div class="row min-vh-100">
            ...
            <div class="col-12">
                ...
                <main class="row">
                    ...
                    <?php
                        $result = mysqli_query($mysqli, "SELECT * FROM products WHERE products.id = '$productId'");
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-9">
                                    <div class="col-12 product-name large">
                                        $name
                                        <small>By Vietnam<a href="#"></a></small>
                                    </div>
                                            ...
                                            <form action="cart.php" method="post">
                                                ...
                                                <div class="col-xl-5 col-md-9 col-sm-3 col-5 mx-auto mt-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="qty" min="1" name="quantity" value="1" class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 mt-3">
                                                    <button class="btn btn-outline-secondary btn-sm" type="submit"><i class="fas fa-heart mr-2"></i>$productId</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
