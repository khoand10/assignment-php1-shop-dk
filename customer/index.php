                        ...
                        <div class="row">
                            <div class="col-auto mr-auto">
                                <ul class="top-nav">
                                    <?php
                                        ...
                                        <li>
                                            <a href="mailto:mail@ecom.com"><i class="fa fa-envelope mr-2"></i>$email</a>
                                        </li>
                                        DISPLAY_INFO;
                                        echo $display_phone;
                            ...
                            <div class="col-auto">
                                <ul class="top-nav">
                                    ...
                                    <li>
                                        <a href="login.php"><i class="fas fa-sign-in-alt mr-2"></i>Login with SMS</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                                ...
                                                <div class="col-12 bg-white text-center h-100 product-item">
                                                    <div class="row h-100">
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            <a href="product.html" class="product-name">$name</a>
                                                        </div>
                                                        <div class="col-12 mb-3">
